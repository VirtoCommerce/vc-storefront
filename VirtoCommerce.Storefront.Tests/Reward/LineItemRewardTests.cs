    ...
    public class LineItemRewardTests
    {
        ...
        public static IEnumerable<object[]> TestRewards
        {
            get
            {
                ...
                // Money limit
                // Not exceeded, quantity set to 4  =  $10 discount on one item (2 items discounted  = $100 total)
                yield return new object[] { 100.0m, 10, 10.0m, new[] { new PromotionReward { ForNthQuantity = 2, InEveryNthQuantity = 3, MaxLimit = 150, Quantity = 4, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                // $150 limit reached, quantity set to 6  =  $15 discount on one item (4 items discounted, but $150 limit = $150 total discount)
                ...
                // Limit not set, quantity set to 10  =  no discount (it is current behavior, probably expected)
                yield return new object[] { 100.0m, 10, 0m, new[] { new PromotionReward { ForNthQuantity = 2, InEveryNthQuantity = 3, Quantity = 10, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };

                // Item limit
                // Limit 6 items not to exceed $500 = $20 discount on one item (limit 6 items = 4 discounted = $200 total discount)
                yield return new object[] { 100.0m, 10, 20.0m, new[] { new PromotionReward { ForNthQuantity = 2, InEveryNthQuantity = 3, MaxLimit = 500, Quantity = 6, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                // Limit 10 items not to exceed $500 = $30 discount on one item (10 items total with 10 limit = 3 discounted = $300 total discount)
                ...
                // Limit 50 items not to exceed $500 = $30 discount on one item (10 items total with 50 limit = 3 discounted = $300 total discount)
                yield return new object[] { 100.0m, 10, 30.0m, new[] { new PromotionReward { ForNthQuantity = 2, InEveryNthQuantity = 3, MaxLimit = 500, Quantity = 10, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                ...
                // For 1 in every 3 items of total 9 items with price $100 get %50 off limit 10 items not to exceed $500  =  $16.66 per item (3 discounted, 150 / 9)
                ...
                // For 1 in every 3 items of total 10 items with price $100 get %50 off limit 10 items not to exceed $500  =  $15 per item (3 discounted, 150 / 10)
                ...
                // For 1 in every 3 items of total 0 items with price $100 get %50 off limit 10 items not to exceed $500  =  $0 per item ( no items )
                ...
                // For 1 in every 1 items of total 10 items with price $100 get %50 off limit 10 items not to exceed $1000  =  $50 per item ( every item discounted by 50 )
                ...
                // For 0 in every 3 items of total 10 items with price $100 get %50 off limit 10 items not to exceed $1000  =  $0 per item ( ForNthQuantity = 0 )
                yield return new object[] { 100.0m, 10, 0m, new[] { new PromotionReward { ForNthQuantity = 0, InEveryNthQuantity = 3, MaxLimit = 1000, Quantity = 10, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                // For <null> in every 3 items of total 10 items with price $100 get %50 off limit 10 items not to exceed $1000  =  $0 per item ( ForNthQuantity not set )
                yield return new object[] { 100.0m, 10, 0m, new[] { new PromotionReward { InEveryNthQuantity = 3, MaxLimit = 1000, Quantity = 10, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                // For 1 in every 0 items of total 10 items with price $100 get %50 off limit 10 items not to exceed $1000  =  $0 per item ( InEveryNthQuantity = 0 )
                yield return new object[] { 100.0m, 10, 0m, new[] { new PromotionReward { ForNthQuantity = 1, InEveryNthQuantity = 0, MaxLimit = 1000, Quantity = 10, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                // For 1 in every <null> items of total 10 items with price $100 get %50 off limit 10 items not to exceed $1000  =  $0 per item ( InEveryNthQuantity not set )
                yield return new object[] { 100.0m, 10, 0m, new[] { new PromotionReward { ForNthQuantity = 1, MaxLimit = 1000, Quantity = 10, Amount = 50, AmountType = AmountType.Relative, RewardType = PromotionRewardType.CatalogItemAmountReward, IsValid = true, Promotion = samplePromotion } } };
                // For 3 in every 2 items of total 10 items with price $100 get %50 off limit 10 items not to exceed $1000  =  $50 per item ( 3 of 2 = all items discounted )
