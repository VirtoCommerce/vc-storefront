        ...
        public ContentItem Parse(string path, string content, ContentItem item)
        {
            ...
            switch (item)
            {
                case ContentPage page when page.FileName.EndsWith(".page"):
                    ...
                    break;
                case ContentPage page when StaticContentItemBuilder.extensions.Any(page.FileName.EndsWith):
                    page.Template = "page";
                    break;
                case BlogArticle page when page.FileName.EndsWith(".page"):
                    page.Template = "json-article";
                    break;
                case BlogArticle page when StaticContentItemBuilder.extensions.Any(page.FileName.EndsWith):
