...
namespace VirtoCommerce.Storefront.Domain.Security
{
    ...
    public sealed class ExperienceUserStoreStub :
        ...
        IUserAuthenticatorKeyStore<User>
    {
        ...
        private readonly SecurityGraphQLProvider _securityGraphQLProvider;


        public ExperienceUserStoreStub(
            IMemberService memberService,
            IStorefrontMemoryCache memoryCache,
            IOptions<StorefrontOptions> options,
            IOrderModule orderModule, SecurityGraphQLProvider securityGraphQLProvider)
        {
            _memoryCache = memoryCache;
            _memberService = memberService;
            _options = options.Value;
            _orderModule = orderModule;
            _securityGraphQLProvider = securityGraphQLProvider;
        }
        ...
        public async Task<IdentityResult> CreateAsync(User user, CancellationToken cancellationToken)
        {
            ...
            var result = await _securityGraphQLProvider.CreateUserAsync(user);
            return result;
        }
        public async Task<IdentityResult> CreateAsync(Role role, CancellationToken cancellationToken)
        {
            var result = await _securityGraphQLProvider.UpdateRoleAsync(role);
            return result;
        }

        public async Task<IdentityResult> DeleteAsync(User user, CancellationToken cancellationToken)
        {
            await _securityGraphQLProvider.DeleteUserAsync(user.UserName);
        ...
        public async Task<User> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            {
                var user = await _securityGraphQLProvider.GetUserByIdAsync(userId);

                return await PrepareUserResultAsync(cacheEntry, user);
        ...
        public async Task<User> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            ...
            var result = await _memoryCache.GetOrCreateExclusiveAsync(cacheKey, async (cacheEntry) =>
            {
                var user = await _securityGraphQLProvider.GetUserByNameAsync(normalizedUserName);
        ...
        public async Task<IdentityResult> UpdateAsync(User user, CancellationToken cancellationToken)
        {
            ...
            var result = await _securityGraphQLProvider.UpdateUserAsync(user);
        ...
        public async Task<User> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken)
        {
            ...
            var result = await _memoryCache.GetOrCreateExclusiveAsync(cacheKey, async (cacheEntry) =>
            {
                var userDto = await _securityGraphQLProvider.GetUserByEmailAsync(normalizedEmail);
        ...
        public async Task<User> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken)
        {
            ...
            var result = await _memoryCache.GetOrCreateExclusiveAsync(cacheKey, async (cacheEntry) =>
            {
                var userDto = await _securityGraphQLProvider.GetUserByLoginAsync(loginProvider, providerKey);
        ...
        {
            var result = await _securityGraphQLProvider.GetRoleAsync(roleId);
            return result;
        }
        ...
        private async Task<User> PrepareUserResultAsync(MemoryCacheEntryOptions options, User user)
        {
            if (user != null)
            {
