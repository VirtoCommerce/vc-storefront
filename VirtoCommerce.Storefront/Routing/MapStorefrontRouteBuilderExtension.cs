...
namespace VirtoCommerce.Storefront.Routing
{
    ...
    public static class MapStorefrontRouteBuilderExtension
    {
        public static void MapStorefrontRoutes(this IRouteBuilder routes)
        {
            ...
            routes.MapStorefrontRoute("API.Lists.CreateList", "storefrontapi/lists/{listName}/create", defaults: new { controller = "ApiLists", action = "CreateList" }, constraints: new RouteValueDictionary(new { httpMethod = new HttpMethodRouteConstraint("POST") }));
            routes.MapStorefrontRoute("API.Lists.CreatePredefindedLists", "storefrontapi/lists/createpredefinedlists", defaults: new { controller = "ApiLists", action = "CreatePredefindedLists" }, constraints: new RouteValueDictionary(new { httpMethod = new HttpMethodRouteConstraint("POST") }));
            ...
            routes.MapStorefrontRoute("API.Lists.MergeWithCurrentCart", "storefrontapi/lists/{listName}/mergewithcurrentcart", defaults: new { controller = "ApiLists", action = "MergeWithCurrentCart" }, constraints: new RouteValueDictionary(new { httpMethod = new HttpMethodRouteConstraint("POST") }));
