...
$modules = @('Cache','Cart','Catalog','Content','Core','Customer','DerivativeContracts','Inventory','Marketing','Orders','Platform','Pricing','ProductRecommendations,'Quote','Sitemaps','Store','Subscription')
