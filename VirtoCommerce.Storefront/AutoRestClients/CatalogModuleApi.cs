...
namespace VirtoCommerce.Storefront.AutoRestClients.CatalogModuleApi
{
    ...
    public static partial class CatalogModulePropertiesExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this ICatalogModuleProperties operations, string id, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteWithHttpMessagesAsync(id, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
...
namespace VirtoCommerce.Storefront.AutoRestClients.CatalogModuleApi.Models
{
    ...
    public partial class ListEntry
    {
        ...
        public ListEntry(string id = default(string), string type = default(string), bool? isActive = default(bool?), string imageUrl = default(string), string code = default(string), string name = default(string), IList<ListEntryLink> links = default(IList<ListEntryLink>), IList<string> outline = default(IList<string>), IList<string> path = default(IList<string>))
        {
            Id = id;
            Type = type;
            IsActive = isActive;
...
namespace VirtoCommerce.Storefront.AutoRestClients.CatalogModuleApi.Models
{
    ...
    public partial class CategorySearchCriteria
    {
        ...
        /// Initializes a new instance of the CategorySearchCriteria class.
        /// </summary>
        public CategorySearchCriteria(string objectType = default(string), string storeId = default(string), string catalogId = default(string), string outline = default(string), IList<string> outlines = default(IList<string>), IList<string> terms = default(IList<string>), string responseGroup = default(string), IList<string> objectTypes = default(IList<string>), IList<string> objectIds = default(IList<string>), string searchPhrase = default(string), string languageCode = default(string), string sort = default(string), IList<SortInfo> sortInfos = default(IList<SortInfo>), int? skip = default(int?), int? take = default(int?))
        {
            ObjectType = objectType;
            StoreId = storeId;
            CatalogId = catalogId;
