...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi
{
    ...
    public partial class CustomerReviews : IServiceOperations<CustomerReviewsWebRESTAPIdocumentation>, ICustomerReviews
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> UpvoteWithHttpMessagesAsync(string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (id == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "Upvote", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/customerReviews/upvote/{id}").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> DownvoteWithHttpMessagesAsync(string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (id == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "id");
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "Downvote", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/customerReviews/downvote/{id}").ToString();
            _url = _url.Replace("{id}", System.Uri.EscapeDataString(id));
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi
{
    ...
    public partial interface ICustomerReviews
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> UpvoteWithHttpMessagesAsync(string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='id'>
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> DownvoteWithHttpMessagesAsync(string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
// Code generated by Microsoft (R) AutoRest Code Generator 1.2.2.0
// Changes may cause incorrect behavior and will be lost if the code is
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi
{
    ...
    public static partial class CustomerReviewsExtensions
    {
        ...
        /// <param name='id'>
        /// </param>
        public static void Upvote(this ICustomerReviews operations, string id)
        {
            operations.UpvoteAsync(id).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async Task UpvoteAsync(this ICustomerReviews operations, string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            (await operations.UpvoteWithHttpMessagesAsync(id, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
        ...
        /// <param name='id'>
        /// </param>
        public static void Downvote(this ICustomerReviews operations, string id)
        {
            operations.DownvoteAsync(id).GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async Task DownvoteAsync(this ICustomerReviews operations, string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            (await operations.DownvoteWithHttpMessagesAsync(id, null, cancellationToken).ConfigureAwait(false)).Dispose();
        }
...
namespace VirtoCommerce.Storefront.AutoRestClients.CustomerReviews.WebModuleApi.Models
{
    ...
    public partial class CustomerReview
    {
        ...
        /// Initializes a new instance of the CustomerReview class.
        /// </summary>
        public CustomerReview(string authorNickname = default(string), string content = default(string), bool? isActive = default(bool?), string productId = default(string), bool? isRecommended = default(bool?), int? voteCount = default(int?), int? rate = default(int?), System.DateTime? createdDate = default(System.DateTime?), System.DateTime? modifiedDate = default(System.DateTime?), string createdBy = default(string), string modifiedBy = default(string), string id = default(string))
        {
