...
namespace VirtoCommerce.Storefront.AutoRestClients.CoreModuleApi
{
    ...
    public partial class StorefrontSecurity : IServiceOperations<VirtoCommerceCoreRESTAPIdocumentation>, IStorefrontSecurity
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> GenerateInviteTokenWithHttpMessagesAsync(string userId, string storeName, string language, string callbackUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (userId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "userId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("callbackUrl", callbackUrl);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GenerateInviteToken", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
...
namespace VirtoCommerce.Storefront.AutoRestClients.CoreModuleApi
{
    ...
    public partial interface IStorefrontSecurity
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> GenerateInviteTokenWithHttpMessagesAsync(string userId, string storeName, string language, string callbackUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
// Code generated by Microsoft (R) AutoRest Code Generator 1.2.2.0
// Changes may cause incorrect behavior and will be lost if the code is
...
namespace VirtoCommerce.Storefront.AutoRestClients.CoreModuleApi
{
    ...
    public static partial class StorefrontSecurityExtensions
    {
            ...
            /// <param name='callbackUrl'>
            /// </param>
            public static void GenerateInviteToken(this IStorefrontSecurity operations, string userId, string storeName, string language, string callbackUrl)
            {
                operations.GenerateInviteTokenAsync(userId, storeName, language, callbackUrl).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task GenerateInviteTokenAsync(this IStorefrontSecurity operations, string userId, string storeName, string language, string callbackUrl, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.GenerateInviteTokenWithHttpMessagesAsync(userId, storeName, language, callbackUrl, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
