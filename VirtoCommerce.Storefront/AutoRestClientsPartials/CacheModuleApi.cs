...
namespace VirtoCommerce.Storefront.AutoRestClients.CacheModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceCacheRESTAPIdocumentation
    {
        public VirtoCommerceCacheRESTAPIdocumentation(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
            : base(httpClient)
        {
