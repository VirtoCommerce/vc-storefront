...
namespace VirtoCommerce.Storefront.AutoRestClients.CacheModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceCacheRESTAPIdocumentationExtended : VirtoCommerceCacheRESTAPIdocumentation
    {
        public VirtoCommerceCacheRESTAPIdocumentationExtended(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
