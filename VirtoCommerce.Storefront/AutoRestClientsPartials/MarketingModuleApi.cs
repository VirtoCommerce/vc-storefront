...
namespace VirtoCommerce.Storefront.AutoRestClients.MarketingModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceMarketingRESTAPIdocumentation
    {
        public VirtoCommerceMarketingRESTAPIdocumentation(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
            : base(httpClient)
        {
