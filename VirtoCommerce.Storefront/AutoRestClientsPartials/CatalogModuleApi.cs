...
namespace VirtoCommerce.Storefront.AutoRestClients.CatalogModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceCatalogRESTAPIdocumentationExtended : VirtoCommerceCatalogRESTAPIdocumentation
    {
        public VirtoCommerceCatalogRESTAPIdocumentationExtended(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
