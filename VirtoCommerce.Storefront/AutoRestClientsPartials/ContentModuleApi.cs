...
namespace VirtoCommerce.Storefront.AutoRestClients.ContentModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceContentRESTAPIdocumentation
    {
        public VirtoCommerceContentRESTAPIdocumentation(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
            : base(httpClient)
        {
