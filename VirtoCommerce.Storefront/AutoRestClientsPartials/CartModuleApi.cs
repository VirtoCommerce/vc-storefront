...
namespace VirtoCommerce.Storefront.AutoRestClients.CartModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceCartRESTAPIdocumentation
    {
        public VirtoCommerceCartRESTAPIdocumentation(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
            : base(httpClient)
        {
