...
namespace VirtoCommerce.Storefront.AutoRestClients.InventoryModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceInventoryRESTAPIdocumentation
    {
        public VirtoCommerceInventoryRESTAPIdocumentation(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
            : base(httpClient)
        {
