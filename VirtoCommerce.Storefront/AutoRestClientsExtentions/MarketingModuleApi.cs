...
namespace VirtoCommerce.Storefront.AutoRestClients.MarketingModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceMarketingRESTAPIdocumentationExtended : VirtoCommerceMarketingRESTAPIdocumentation
    {
        public VirtoCommerceMarketingRESTAPIdocumentationExtended(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
