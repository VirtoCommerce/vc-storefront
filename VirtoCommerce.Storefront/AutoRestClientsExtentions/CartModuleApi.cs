...
namespace VirtoCommerce.Storefront.AutoRestClients.CartModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceCartRESTAPIdocumentationExtended : VirtoCommerceCartRESTAPIdocumentation
    {
        public VirtoCommerceCartRESTAPIdocumentationExtended(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
