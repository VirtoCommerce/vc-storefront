...
namespace VirtoCommerce.Storefront.AutoRestClients.OrdersModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceOrdersRESTAPIdocumentationExtended : VirtoCommerceOrdersRESTAPIdocumentation
    {
        public VirtoCommerceOrdersRESTAPIdocumentationExtended(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
