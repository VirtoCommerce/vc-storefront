...
namespace VirtoCommerce.Storefront.AutoRestClients.QuoteModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceQuoteRESTAPIdocumentation
    {
        public VirtoCommerceQuoteRESTAPIdocumentation(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
            : base(httpClient)
        {
