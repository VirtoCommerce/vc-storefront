...
namespace VirtoCommerce.Storefront.AutoRestClients.InventoryModuleApi
{
    ...
    /// </summary>
    public partial class VirtoCommerceInventoryRESTAPIdocumentationExtended : VirtoCommerceInventoryRESTAPIdocumentation
    {
        public VirtoCommerceInventoryRESTAPIdocumentationExtended(HttpClient httpClient, IOptions<PlatformEndpointOptions> options)
